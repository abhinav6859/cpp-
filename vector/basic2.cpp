...
//   vector <int> test_scores (3, 100); // 3 elements all initialized to 100
 ...
 // Example of a 3D-vector
    vector <vector <vector<int>>> movie_rating
    {
    ...
    cout << "\nHere are the movie rating for reviewer #1 using array syntax :" << endl;
    cout << movie_rating[0][0][1] << endl;
    cout << movie_rating[0][1][1] << endl;
    cout << movie_rating[0][2][1]<< endl;
    cout << movie_rating[2][3][1] << endl;
    
     cout << "\nHere are the movie rating for reviewer #1 using vector syntax :" << endl;
    cout << movie_rating.at(0).at(0).at(2) << endl;
    cout << movie_rating.at(0).at(1) .at(2)<< endl;
    cout << movie_rating.at(0).at(2).at(2) << endl;
    cout << movie_rating.at(0).at(3).at(2) << endl;
